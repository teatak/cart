...
func (n *node) addRoute(path string, handle ComposeHandle) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle ComposeHandle) {
...
// given path.
func (n *node) getValue(path string) (handle ComposeHandle, p Params, tsr bool) {
